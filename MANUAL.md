...
>
> ⚠️ **사진 용량 주의**: 스마트폰 원본을 그대로 올리면 파일당 수 MB~수십 MB가 되어 사이트가 느려짐.
> 업로드 전에 **긴 변 기준 1600~2000px, 파일당 300KB~1MB** 정도로 줄여서 올릴 것.
> 무료 압축 도구: [squoosh.app](https://squoosh.app) (브라우저에서 바로 압축, 서버 업로드 없음)
